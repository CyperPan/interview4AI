...
这个仓库现在不再把内容简单按“专题并列”堆放，而是优先按 **LLM 推理主线** 和 **LLM 训练主线** 来组织。

这样做的原因很直接：

- 面试官不会按文档标题提问，而是会沿着系统流程追问
- 你真正需要建立的是“从输入到输出、从数据到参数更新”的整体链路
- 每个流程节点下面，再去挂相关面试问题、数学推导、代码实现和公司面经，才更接近真实面试方式
